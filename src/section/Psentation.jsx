        ...
        <div className='mb-[50px] px-[50px] flex gap-[20px] flex-col items-center justify-center'>
            <div className='w-full px-[10px] py-[10px] relative flex flex-col items-center justify-center gap-[30px] lg:gap-[40px] md:gap-[35px] sm:gap-[30px]'>
                ...
                <h1 className='text-[#BEB8D2] text-[22px] lg:text-[32px] md:text-[30px] sm:text-[24pxs] font-bold'>
                    Друзі, всі ви взявши участь в нашому марафоні отримуєте черговий подарунок від нас!
                </h1>
                ...
                <div className='w-full flex justify-center gap-[50px] items-center flex-wrap lg:flex-nowrap md:flex-wrap sm:flex-wrap'>
                    ...
                    <PresentationItem title="PRO" firstText="Підходить для вас, якщо ви торгуєте або починає торгувати на ф’ючерсах і ваші угоди не виводить вас в прибуток або ви ще не вмієте аналізувати графіки." secondText="Включає в себе уроки про технічну частину - як працюють бінанс ф’ючерси, широке вивчення концепції SmartMoney, ризик менеджменту, формування торгово їстратегії, а також психології під час торгівлі"/>
            ...
            <a href="https://tothemoon.one/#Tariffs">
                <button className='bg-[#7464ac] text-[#cebfff] w-[200px] text-[16px] px-[20px] py-[10px] rounded-[3px]'>
                    Обрати тариф
                </button>
            </a>
