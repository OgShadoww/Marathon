    ...
    return (
        <div ref={Elementref} className='flex flex-col justify-center items-center mb-[100px]'>
            ...
            <div className='flex flex-col md:flex-col sm:flex-col lg:flex-row md:justify-center items-center lg:justify-between gap-[50px] w-full px-[30px] lg:px-[100px] md:px-[50px]'>
                ...
                <VideoItem live={videoArray[videoCurrent].live} stream={videoArray[videoCurrent].stream} video={videoArray[videoCurrent].video} nextCurrent={nextCurrent} prevCurrent={prevCurrent} title={videoArray[videoCurrent].title} question={videoArray[videoCurrent].question}/>
            </div>
        </div>
    );
};
