...
const LineSuccessHorizontal = ({current, changeCurrent, num}) => {
    const baseStyle = ['flex flex-col justify-center items-center text-[16px] md:text-[22px] font-bold rounded-[50%] w-[35px] h-[35px] md:w-[45px] md:h-[45px] sm:w-[35px] sm:h-[35px] mt-[50px] md:mt-[-15px] sm:mt-[10px] md:ml-0 lg:ml-[-6%] z-10 cursor-pointer transition-[0.4s]', 'bg-[#D9D0FF] text-[#8880A8]']
