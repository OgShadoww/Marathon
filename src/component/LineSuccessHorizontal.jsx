...
const LineSuccessHorizontal = ({current, changeCurrent, num}) => {
    const baseStyle = ['flex flex-col justify-center items-center text-[16px] md:text-[22px] font-bold rounded-[50%] w-[30px] h-[30px] md:w-[45px] md:h-[45px] sm:w-[30px] sm:h-[30px] mt-[-10px] md:mt-[-15px] sm:mt-[-10px] md:ml-0 lg:ml-[-6%] z-10 cursor-pointer transition-[0.4s]', 'bg-[#D9D0FF] text-[#8880A8]']
