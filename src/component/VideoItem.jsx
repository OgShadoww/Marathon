    ...
    return (
        <div className='bg-[#D9D9D9] flex flex-col gap-[20px] items-start justify-center  bg-opacity-[0.1] w-[100%] lg:w-[70%] md:w-[90%] sm:w-[90%] px-[15px] py-[10px] youtube'>
            ...
            <div className='flex justify-between items-center w-full mb-[20px]'>
                <button onClick={() => prevCurrent()} className='bg-gradient-to-r from-[#3588D2] to-[#91C5F2] px-[50px] py-[15px] text-white rounded-[10px] w-[30%] text-[16px] lg:text-[24px] md:text-[22px] sm:text-[20px] flex items-center justify-center'>Попередній</button>
                <button onClick={() => nextCurrent()} className='bg-gradient-to-r from-[#3588D2] to-[#91C5F2] px-[50px] py-[15px] text-white rounded-[10px] w-[30%] text-[16px] lg:text-[24px] md:text-[22px] sm:text-[20px] flex items-center justify-center'>Наступий</button>
            </div>
